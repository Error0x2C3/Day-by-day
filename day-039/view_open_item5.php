        ...
        <div class="colonne-droite">   <!--- classe parent qui gére la colonne droite. --->
            <div class="pricing card ">
                ...
                <?php else: ?>
                    ...
                    <?php elseif($item->get_owner_user() == $user->get_id()): ?>
                        <!-- S'il y a un gagnant.-->
                        <?php if($winner instanceof Bids):?>
                            <p class="winner-phrase"><span><?php $winner->get_owner_user()->get_pseudo()?> won this for </span><?php echo number_format($item->get_max_bid(), 2, ',', '.'); ?>.</p>
                        <?php elseif(!$winner):?>
