...
/*
✔️ Contrat equals / hashCode respecté :
Si equals() est vrai (day identique)
alors hashCode() est identique (day % 4)
👉 OK
✔️ Mauvaise fonction de hachage volontaire
Seulement 4 valeurs possibles (0,1,2,3)

Donc énormément de collisions
Beaucoup d’objets dans les mêmes buckets.
➡️ Exactement ce que l’énoncé demande.
⚠️ Remarque 1 — “mauvais” ≠ “faux”.

Ton code est :
❌ mauvais pour les performances.
✅ correct fonctionnellement.
👉 Le HashSet marche toujours, mais devient lent (beaucoup de equals()).
 */
