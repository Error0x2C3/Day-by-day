...
alter table restaurants
    drop constraint if exists contraint_name_city;

ALTER TABLE restaurants
    ADD CONSTRAINT contraint_name_city
        UNIQUE (name,city); --Voir schéma consigne--
/* --- Contrainte d'unicité ---*/
...
$$
begin
    -- si c'est un INSERT ou un UPDATE, on l'encrypte.
    if tg_op = 'INSERT' OR tg_op = 'UPDATE' then
