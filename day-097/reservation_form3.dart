...
class ReservationFormScreen extends  ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // le ! de reservationCurrent!
    final services = clientState.servicesDujour(reservationCurrent!,reservationCurrent.timestamp.weekday);  // weekday => obetenir le jour de la semaine à partir d'un DateTime.
    var restaurant =  clientState.getRestaurantReservation(reservationCurrent.restaurant.id);
    final dateAffichee = clientState.getDateReservationAffichee(reservationCurrent!.timestamp);
    // var NbrConviveAffichee = clientState.getNbrConviveReservationAffichee(reservationCurrent.numberOfGuests);
    final  List<TimeOfDay> ListAvailableBookingtTimes = clientState.getAvailableBookingTimes(services);
