...
class Items extends Model {
    ...
    /*
    Vérifie si peut recevoir des offres d'achat (enchères)
    de la part des utilisateurs de l'application.
     */
    public function can_receive_purchase_offers(): bool{
        if($this->starting_bid > 0 && isset($this->starting_bid)){
            return true;
        }
        return false;
    }
     ...
     */
    public function can_buy_immediately_by_buy_now_price($price_by_user): bool{
        // TODO
        ...
        if(isset($this->buy_now_price) && $price_by_user >= $this->buy_now_price && $this->starting_bid == null){
            return true;
        }
        return false;
    }
    ...
    public function save ($owner,$created_at){
        ...
        if($this->validate()){
            ...
            $this->persist( $this->title , $this->description,$this->created_at,$this->duration_days ,$this->owner_id,$this->buy_now_price, $this->starting_bid );
        }
        else{
            return $this->errors;
        }
