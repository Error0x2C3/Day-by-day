...
class ControllerItem extends Controller {
    ...
    */
    ...
    public function edit_item_view(): void{
        ...
        if(isset($_GET['param1'])){
            ...
            $btn_back ="";
            if(isset($_GET['param2'])){ $btn_back = Navigation::desanitize($_GET['param2']);}
    ...
    public function add_item_from_form(): void {
        ...
        // --- Validations métier ---
        if (strlen($title) < (int)Configuration::get("title_min_length")
            || strlen($title) > (int)Configuration::get("title_max_length")) {
        ...
        if ($duration_int < (int)Configuration::get("duration_days_item_min")
            || $duration_int > (int)Configuration::get("duration_days_item_max")) {
        ...
        // Rediriger vers open_item du nouvel item
        $new_id = (string)Items::lastInsertId2();
        $this->redirect("item", "open_item_view", $new_id);
    }
   ...
   ========================================================= */
    ...
    public function open_item_view():void {
        ...
        $btn_back = isset($_GET['param2']) ? Navigation::desanitize($_GET['param2']) : null;
...
//        echo $activeItems[0]["title"];
   ...
   ========================================================= */
    ...
    public function manage_images_view($item_id_param = false): void{
        ...
        $btn_back = "item/open_item_view/".$item_id;
