...
<?php
echo Navigation::top_bar("profile/sales_view","Purchases",$btn_back ?? "");
?>
<main class="page-content p-3">
    <div class="container py-2">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge rounded-pill bg-primary px-3 py-2">4 purchases</span>
        </div>
        ...
        <div class="row g-3 mb-5">
            <div class="col-md-4">
                <div class="stats-card p-4 h-100">
                    ...
                    <h3 class="stats-value">€ 1.688,00</h3>
                    <p class="stats-subtext">Across 2 purchases</p>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="stats-card p-4 h-100">
                    ...
                    <h3 class="stats-value">€ 420,00</h3>
            ...
            <div class="col-md-4">
                <div class="stats-card p-4 h-100">
                    ...
                    <h3 class="stats-value">Quentin</h3>
                ...
                <?php foreach($list_items as $item): ?>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        ...
                        <div class="mt-3 text-secondary small">
                            <div class="mb-1">
                                <i class="bi bi-currency-dollar"></i> Paid  <?php echo number_format($item->get_max_bid(), 2, ',', '.'); ?>
                            </div>
                            <div>
