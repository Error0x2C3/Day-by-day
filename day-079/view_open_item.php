...
console.log('contenu avant :', $grid.html());
            ...
            $.each(images, function (i, src) {
                if (i === 0) return; // on skip la première (déjà affichée)
        ...
        <div class="colonne-droite">   <!--- classe parent qui gére la colonne droite. --->
            ...
            <?php if($item->get_owner_id() == $user->get_id() && isset($item)): ?>
                <div class="manage-your-item card">
                    ...
                    <a href="item/delete/<?php $item->get_id()?>/<?=Navigation::encode($btn_back)?>" class="btn delete-item-btn w-100">
