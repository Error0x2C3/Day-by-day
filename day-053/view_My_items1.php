...
<main class="page-content p-3">
    <div class="container py-2">
        <?php if ( isset($activeItems) && !empty($activeItems)): ?>
            ...
            <div class="row g-3 mb-5">
                <?php foreach ( $activeItems as $item) {?>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card" >
                            <?php
                            $mon_tableau = ["item/my_items_view", "item/open_item_view/".$item->get_id()];
                            $json = json_encode($mon_tableau);
                            $donnees_codees = str_replace(['+', '/', '='], ['-', '_', ''], base64_encode($json));
                            ?>
                            <a href="historynav/manage_btn_back/forward/<?=$donnees_codees?>" class="stretched-link"></a>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card" >
                            ...
                            <div class="card-body">
                                ...
                                <?php if( !$item->time_has_passed() && !$item->should_close()): ?>
                                    <p class="card-timer-custom mt-3 mb-0">
                                        <i class="bi bi-clock"></i>
                                        <?php echo $item->time_elapsed_string(); ?>
                                    </p>
...
<?php
echo Navigation::bottom_nav("my_items");
