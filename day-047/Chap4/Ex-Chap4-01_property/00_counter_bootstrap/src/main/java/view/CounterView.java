...
public class CounterView extends VBox {
    ...
    public CounterView(BorderPane root_border_panne, CounterModel counter_model,User user){
        ...
        this.user = user;
        // J'associe un listener comme observateur de this.counter.model.nbr_property :
        this.counter_model.nbr_read_property().addListener(random_nbr);
        // J'associe un listener comme observateur de this.counter.model.nbr_property :
        this.user.user_name_read_property().addListener(user_name);
    }
    ...
    public VBox get_vbox_panel(){
        ...
        // ------------------------------------------------
            ...
            // ------------------------------------------------------
                ...
                this.get_user().set_user_name_property(textField_name_user.getText()); // après l'exécution de cette méthode, il excutera la méthode update.
                /*
                ...
                // -----------------------------------------------------------
                    ...
                    // ----------------------------------------
                        ...
                        btn_less.setOnAction(e->{
                            try{
                                counter_model.set_nbr_property( counter_model.nbr_read_property().get() -1);
                                // System.out.println( counter_model.nbr_reed_property().get() );
                                /*
                                ...
                                */
                                label_text_number.setText( String.valueOf(counter_model.nbr_read_property().get() ) );
                                /*
    ...
    ChangeListener<Number> random_nbr = (obs, oldValue, newValue) ->{
        /*
         ...
         */
        if( obs == this.counter_model.nbr_read_property() ){
            this.label_text_number.setText( String.valueOf( this.counter_model.nbr_read_property().get()) );
        }
    };
    ChangeListener<String> user_name = (obs, oldValue, newValue) ->{
        /*
        Quand la variable Property crie dans le mégaphone, c'est bien elle-même qu'elle passe dans obs,
        Idem qu'avec la méthode udpate des Observables/Observers.
         */
        if( obs == this.user.user_name_read_property() ){
