    ...
    */
    ...
    public static function bottom_nav(string $active,?User $user = null): string {
        ...
        // echo $user->get_role()->value;
            ...
            $html .=         '</a>';
            if(isset($user) && $user->get_role() === Role::Admin){
                $html .=         '<a class="nav-item-btn ' . ($active === 'categories' ? 'active' : '') . '" href="categories/categories_view/">';
                $html .=             '<i class="bi bi-columns-gap"></i></i><span>Categories</span>';
                $html .=         '</a>';
            }
