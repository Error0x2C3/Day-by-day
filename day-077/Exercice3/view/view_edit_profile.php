    ...
    <body>
        ...
        <div class="main">
            <form method='post' action='member/edit_profile' enctype='multipart/form-data'>
                ...
                <textarea name='profile' cols='50' rows='3'><?= $member->profile ?></textarea>

                Image: <input type='file' name='image' accept="image/x-png, image/gif, image/jpeg">
                <?php if ($member->picture_path): ?>
                    <img src='upload/<?= $member->picture_path ?>' width="100" alt="Profile image">
                <?php endif; ?>
