...
<head>
    ...
    }else if(isset($page_title) && $page_title == "Edit item" && isset($item)){
        // Cas ou on est dans un edit item.
        echo Navigation::top_bar("item/add_edit_item_view", $page_title ?? "Edit item",$btn_back ?? "item/open_item_view/".$item->get_id(), "item-form");
    }
    ?>
