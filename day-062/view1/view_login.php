...
<div class="min-vh-100 d-flex flex-column align-items-center justify-content-center">
    <div class="d-flex justify-content-center align-items-center logo-header mb-4">
    ...
    <div class="login-card p-4">
        ...
        <form action="login/login_check" method="post">
            ...
            <?php if (isset($correct)): ?>
                <div class="alert alert-success d-flex align-items-center mt-3" role="alert">
                    ...
                    <div>
                        <?php echo "The account has been successfully created."; ?>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <!--prod.ini c'est le résultat final que l'utilisateur a. -->
        <?php if(Configuration::is_dev()) : ?>
            <div class="small">
                ...
                <div>
                    <a href="login/login_connect_as_marc" class="debug-line text-secondary"> Login as <span class="text-success">mamichel@epfc.eu</span></a>
                </div>
                <div>
