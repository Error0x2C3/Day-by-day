...
<head>
    ...
    <?php
    $back_link = isset($item) ? "historynav/manage_btn_back/back/" . $item->get_id() : "";
    echo Navigation::top_bar("item/add_edit_item_view", $page_title ?? "",$btn_back ?? "item/open_item_view/".$item->get_id(), "item-form");
    ?>
