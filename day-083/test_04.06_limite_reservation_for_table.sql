...
$test$
    begin
        ...
        PERFORM should_fail($$
        INSERT INTO reservations (id, client, restaurant, datetime, number_of_guests, status, special_requests) VALUES (23, 6, 1, '2024-11-15 19:00:00.000000', 2, 'confirmed', 'visite');
        $$, 'raise_exception');
    end
$test$;
rollback;
...
--         INSERT INTO reservations ( client, restaurant, datetime, number_of_guests, status, special_requests) VALUES ( 6, 1, '2026-11-15 21:00:00.000000', 2, 'confirmed', 'visite')
