...
<body>
<main class="page-content p-3"> <!---classe parent qui gére la grille, le container. --->
    ...
    <div class="colonne-droite">   <!--- classe parent qui gére la colonne droite. --->
        <div class="pricing card ">
            ...
            <button class="bid-row-btn w-100">Place Bid</button>
            <button class="buy-row-btn w-100">Buy Now at </button>
        </div>
