...
<main class=" p-3">
    ...
    <?php if(isset($item))echo  $item->get_id(); ?>
    <div class="page-content py-2"> <!---classe parent qui gére la grille, le container. --->
        ...
        <div class="colonne-droite">   <!--- classe parent qui gére la colonne droite. --->
            ...
            <div class="manage-your-item card">
                ...
                <button class="btn edit-item-details-btn w-100">Edit item Details</button>
                <button class="btn manage-images-btn w-100">Manage Images</button>
                <button class="btn delete-item-btn w-100">Delete item</button>
            </div>
        </div>
    </div>
</main>
