...
<main class="page-content p-3">
    <div class="container py-2">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <span class="badge rounded-pill bg-success px-3 py-2"><?php if(isset($word_sale)){ echo $word_sale;}?></span>
        </div>
        ...
        <div class="row g-3 mb-5">
            <div class="col-md-4">
                <div class="stats-card p-4 h-100">
                    ...
                    <h3 class="stats-value">€ <?php if(isset($sum_revenue)){echo number_format($sum_revenue, 2, ',', '.');} ?></h3>
            ...
            <div class="col-md-4">
                <div class="stats-card p-4 h-100">
                    ...
                    <h3 class="stats-value"><?php if(isset($recurring_winning)){ echo $recurring_winning;}?></h3>
            ...
            <?php if(isset($list_items) && isset($user)): ?>
                <?php foreach($list_items as $item): ?>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card">
                            <?php
                            $btn_back = Navigation::sanitize("profile/sales_view/");
                            ?>
                            <a href="item/open_item_view/<?= $item->get_id()?>/<?=$btn_back?>" class="stretched-link"></a>
                        ...
                        <div class="mt-3 text-secondary small">
                            <div class="mb-1">
                                <i class="bi bi-currency-dollar"></i> Final price €  <?php echo number_format($item->get_max_bid(), 2, ',', '.'); ?>
                            </div>
                            <div class="mb-1">
                                <i class="bi bi-trophy"></i> <?php echo $item->has_a_winner()->get_owner_pseudo();?>
                            </div>
                            <div>
                                <i class="bi bi-clock"></i> Closed on <?php echo $item->get_end_at()->format('d-m-Y H:i:s');?>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
