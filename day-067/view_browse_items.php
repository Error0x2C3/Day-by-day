                ...
                <?php foreach ($list_items_user_participing as $item) {?>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card">
                            <?php
                            ?>
                            <a href="item/open_item_view/<?= $item->get_id();?>/<?=Navigation::decode("item/browse_items_view/")?>" class="stretched-link"></a>
            ...
            <div class="row g-3 mb-5">
                <?php foreach ($list_other_available_items as $item) {?>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card">
                            <?php
                            $btn_back = Navigation::encode("item/browse_items_view/");
                            ?>
