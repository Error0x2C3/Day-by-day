...
?>
<?php
echo Navigation::top_bar("item/open_item_view/".$item->get_id(),"Open item",$btn_back ?? "item/browse_items_view");
?>
<main class=" p-3">
        ...
        <div class="colonne-droite">   <!--- classe parent qui gére la colonne droite. --->
            ...
            <?php if($item->get_owner_id() == $user->get_id() && isset($item)): ?>
                <div class="manage-your-item card">
                    ...
                    <a href= "item/edit_item_view/<?=$item->get_id()?>/<?= Navigation::encode("item/open_item_view/".$item->get_id())?>" class="btn edit-item-details-btn w-100">
                        <i class="bi bi-pen me-2"></i>Edit item Details
                    </a>
                    <a href="item/manage_images_view/<?=$item->get_id()?>/<?=Navigation::encode("item/open_item_view/".$item->get_id())?>" class="btn manage-images-btn w-100">
                        <i class="bi bi-image me-2"></i>Manage Images
                    </a>
                    <a href="item/delete/<?php $item->get_id() ?>/<?= Navigation::encode("item/open_item_view/".$item->get_id())?>" class="btn delete-item-btn w-100">
