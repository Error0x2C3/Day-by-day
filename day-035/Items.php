 ...
 // Les annonces.
    ...
    */
    ...
    public function has_a_winner():bool|Bids{
        ...
        if($this->has_auction() && $this->has_buy_now() && $this->time_has_passed() && !$this->get_first_winning_buy_now_bid()){
    ...
    */
    ...
    public function init_v_items_status():void{
        try {
            ...
            $this->bid_count = (int)$row['bid_count'];
            $this->max_bid =  $row['max_bid'] == null ? null : (int) $row['max_bid'];
            ...
            $this->buy_now_reached = (bool) $row['buy_now_reached'];
