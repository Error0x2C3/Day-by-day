...
$(async function () {
    let list_balises = [$("#tag_result_filter-participating"),$("#tag_result_filter-avaible-items")];
    ...
    $('#fulltext-search').on('input', async function () {
        let search_content = $(this).val().toLowerCase(); // On récupére la version minuscule du mot.
        ...
        for(let i=0 ; i <= list_balises.length-1 ; i++){
            ...
            element.empty();
            if(i ===0){ // 1 correspond à Items I'm Participating In.
            ...
            }else if( i ===1){ // 2 correspond à Other Available Items.
