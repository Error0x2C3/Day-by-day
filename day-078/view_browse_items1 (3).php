                ...
                <?php foreach($list_items_win as $item): ?>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                        <div class="card">
                            ...
                            <div class="position-relative">
                                ...
                                <div class="card-img-overlay">
                                    <?php $bid_highest = Bids::get_highest_bidder($item->get_id()) instanceof Bids ?  Bids::get_highest_bidder($item->get_id()): null;?>
                                    <?php if($bid_highest instanceof Bids && $bid_highest->get_owner_id() == $user->get_id() ): ?>
                        ...
                        <div class="mt-3 text-secondary small">
                            <div class="mb-1">
                                <i class="bi bi-tag"></i> Paid  <?php echo number_format($item->get_max_bid(), 2, ',', '.'); ?>
                            </div>
                            <div>
