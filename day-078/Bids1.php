...
//        }
    ...
    public function validate_construct(int $owner_id,int $item_id, DateTime $created_at,float $amount):void {
        ...
        if($this->validate_amount($item_id, $amount)){
            ...
            throw new InvalidArgumentException("Le montant de l'enchère doit être positif.");
        }else{
            throw new InvalidArgumentException("Le montant de l'enchère doit être supérieur à l'enchère précédente.");
        }
