...
public class CounterApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Début de la VBox.
        // ------------------------------------------------
        VBox vbox_panel = new VBox(5); // Impose un espace de 15 px entre chaque étage.
        ...
        // Au 1 er étage de la VBox :
            ...
            String contenu_textField_name_user = textField_name_user.getText();
            ...
            textField_name_user.setOnAction(e ->{
                ...
                // 1. On nettoie les anciens messages d'errur pour ne pas les cumuler.
                ...
                if(textField_name_user.getText().trim().length() < 3){
                    ...
                    // Le message d'erreur sera ajouté ET affiché après l'élément qui se trouve à l'index X.
        ...
        // Au 2 ème étage de la VBox :
            ...
            // ------------------------------------------------
                ...
                // ----------------------------------------
                label_txt.setText(String.valueOf(nbr));
                label_txt.setStyle("-fx-text-fill: black; -fx-font-weight: bold;");
                ...
                En mettant HBox.setHgrow(label_txt, Priority.ALWAYS) :
                 ...
                 */
                HBox.setHgrow(label_txt, javafx.scene.layout.Priority.ALWAYS);// Priority.ALWAYS, on lui donnes un "super-pouvoir". Il devient prioritaire pour dévorer tout le vide restant dans la HBox.
                /*
                ...
                */
                 ...
                 */
                label_txt.setAlignment(javafx.geometry.Pos.CENTER);
                // Ajout du texte dans le Hbox.
                hbox_panel.getChildren().add(label_txt);
                // ----------------------------------------
