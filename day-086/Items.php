...
//    }
    ...
    public function delete():bool{
        try {
            // Supprission des
            $pdo1 = self::execute("DELETE FROM item_pictures WHERE item = :id",
                [
                    "id" => $this->get_id()
                ]
            );
            $pdo2 = self::execute("DELETE FROM bids WHERE item = :id",
                [
                    "id" => $this->get_id()
                ]
            );
            $pdo3 = self::execute("DELETE FROM items WHERE id = :id",
                [
                    "id" => $this->get_id()
                ]
            );
