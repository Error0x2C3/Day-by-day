...
<div class="page-content py-2">
    ...
    <div class="card bg-secondary text-center mb-4">
        ...
        <img src="<?php if(isset($user)): echo $user->get_picture_path(); ?><?php endif;?>"
                     ...
                     alt="Profile picture">
                <h5 class="mb-0 text-light "><?php if(isset($user)):echo $user->get_full_Name(); ?><?php endif;?></h5>
    ...
    <div class="card bg-secondary mb-4">
        ...
        <div class="card-body">
            <a href="profile/sales_view/" class="btn btn-outline-primary w-100 text-start mb-3">
    ...
    <div class="card bg-secondary">
        ...
        <div class="card-body">
            <a href="profile/profil_edit_view/" class="btn btn-outline-primary w-100 text-start mb-3">
                <i class="bi bi-person-gear me-2"></i>
                <strong>Edit Profile</strong><br>
                <small class="text-muted">Update your personal information</small>
            </a>
            <a href="profile/profile_change_password_view/" class="btn btn-outline-primary w-100 text-start mb-3">
                <i class="bi bi-shield-lock me-2"></i>
                <strong>Change Password</strong><br>
                <small class="text-muted">Update your account security</small>
            </a>
            <a href="profile/manage_profile_picture_view/" class="btn btn-outline-primary w-100 text-start mb-3">
