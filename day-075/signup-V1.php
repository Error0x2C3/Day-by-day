...
<html>
    ...
    <body>
        ...
        <div class="main">
            ...
            <form action="signup.php" method="post">
                ...
                <input type="submit" value="Sign Up" onclick="generateList();">
            </form>
            <?php 
                if(isset($errors)){
    ...
    <script>
        ...
        function generateList(){
            console.log(condition_pseudo);
            console.log(condition_password);
            console.log(condition_pseudo && condition_password && condition_password_confirm);
        ...
        function checkPasswords(field){
            let condition_password = regex_password.test(field.value);
            let condition_password_confirm = field.value === password ? true:false;
            if(condition_password &&  condition_password_confirm ){
        ...
        function managePassword(){
            if(password !="" && password_confirm !=""){
                ...
                console.log("Les deux mots de passe ont changés.");
            }
