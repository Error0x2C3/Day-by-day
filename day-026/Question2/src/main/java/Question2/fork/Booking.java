...
public class Booking {
    ...
    Booking(User user, List<Table> tables, int numberOfPeople, SteakhouseType steakhouse) {
//        if (steakhouse instanceof SteakhouseTypeA || steakhouse instanceof SteakhouseTypeB) {
//            this.user = user;
//            this.tables = tables;
//            this.numberOfPeople = numberOfPeople;
//            this.steakhouse = steakhouse;
//        } else {
//            throw new IllegalArgumentException("Invalid steakhouse type");
//        }
        this.user = user;
        this.tables = tables;
        this.numberOfPeople = numberOfPeople;
...
//            return ((SteakhouseTypeA) steakhouse).cancel(this);
//        }
//        if (steakhouse instanceof SteakhouseTypeB) {
//            return ((SteakhouseTypeB) steakhouse).cancel(this);
//        }
