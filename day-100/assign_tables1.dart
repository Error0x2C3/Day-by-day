...
class _AssignTablesScreenState extends  ConsumerState<AssignTablesScreen> {
  ...
  final List<model.Table> _selectedTables = [];
  @override
  void initState() {
    super.initState();
  ...
  void _confirm(BuildContext context) {
    ref.read(managerStateProvider.notifier).confirmWithTables(widget.reservation.id, _selectedTableIds, _selectedTables);
