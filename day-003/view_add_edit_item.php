...
<?php
echo Navigation::top_bar("Add item");
?>
    ...
    <form action="Item/save" method="POST">
        ...
        <div class="mb-4 border p-3">
            ...
            <div class="mb-3">
                ...
                required>
                <?php if ($press_save && !empty($errors["bool_text_min_3_max_255"])): ?>
        ...
        <div class="mb-4 border p-3">
            ...
            <div class="border p-3 mb-3">
                ...
                <div class="mb-3">
                    ...
                    <?php if ($press_save && !empty($errors['bool_buy_now_price_UP_starting_bid'])): ?>
                        <div class="text-danger small">
