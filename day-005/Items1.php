...
class Items extends Model {
    ...
    public function validate_starting_bid(float $value): bool{
        ...
        */
        ...
        if($value > 0){
            ...
            if(!preg_match(Configuration::get("decimal_regles"), $value)) {
                return false;
            }
            return false;
        }
    ...
    public function validate_buy_now_price():bool{
        //TODO
        return false;
    }
    /* =========================================================
   ...
   ========================================================= */
    // Annonce a une enchère ou pas.
    public function has_auction(): bool {
        return $this->get_starting_bid() > 0;
    }
    // Annonce a un achat immédiat ou pas.
    ...
    */
    ...
    public function buy_now_price(): bool{
        return false;
    }
    /*
    Vérifie si :
    ...
    /*
    Vérifie si une annonce qui combine les deux systèmes (enchères et achat immédiat) :
        dans ce cas, la première enchère qui atteint ou
        dépasse le prix d'achat immédiat remporte l'annonce
        et clôture les enchères. Si à la fin de la période d'enchères
        aucune enchère n'a atteint le prix d'achat immédiat,
        l'annonce est remportée par l'enchère la plus élevée.
     */
    public function announcement_can_be_close(): bool{
        // Vérifie si l'anonce combine bien les deux systèmes (enchère + achat immédiat).
        if(isset($this->buy_now_price) && $this->starting_bid != 0 && isset($this->starting_bid)){
            //TODO
        }
        return false;
